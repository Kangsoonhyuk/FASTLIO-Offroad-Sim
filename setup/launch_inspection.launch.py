...
def generate_launch_description():
    ...
    # 'test' = inspection.sdf (with trees)
    ...
    # Path to the custom world files
    # Note: We construct the world path dynamically based on the argument
    # But for simplicity in Python logic, we can resolve it.
