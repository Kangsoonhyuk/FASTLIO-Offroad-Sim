...
def generate_launch_description():
    ...
    node_cmd_vel_bridge = Node(
        ...
        arguments=
            [
                'cpr_a200_0000/cmd_vel@geometry_msgs/msg/Twist[ignition.msgs.Twist'
                ,
                '/model/cpr_a200_0000/robot/cmd_vel@geometry_msgs/msg/Twist]ignition.msgs.Twist'
                ,
            ]
        ,
        remappings=
            [
                ...
                ,
                (
                    '/model/cpr_a200_0000/robot/cmd_vel'
                    ,
    ...
    node_odom_base_tf_bridge = Node(
        ...
        arguments=
            [
                '/model/cpr_a200_0000/robot/tf@tf2_msgs/msg/TFMessage[ignition.msgs.Pose_V'
                ,
            ]
        ,
        remappings=
